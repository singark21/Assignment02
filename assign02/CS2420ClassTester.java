...
public class CS2420ClassTester {
	...
	public void testAddScore() {
		// ensure no exceptions thrown
		verySmallClass.addScore(1010101, 100, "assignment");
		assertTrue(100 == verySmallClass.lookup(1010101).getAssignmentScores().get(0));
	...
	@Test
	public void testNullLookupuNID() {
		CS2420Student actual = verySmallClass.lookup(23252321);
	...
	@Test
	public void testSmallLookUpContactInfoEmpty() {
		ArrayList<CS2420Student> actualStudents = verySmallClass.lookup(new EmailAddress("dog", "cat"));
